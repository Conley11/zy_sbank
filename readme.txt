    ...
    ────┤           卓越代码示例结构说明             ├────
            ╰───────────────────────╯ 
　                                                                  
　       接口名称：卓越微课app接口（zhuoyue_api）
　 　 代码版本：1.0
            开发语言：JAVA
            版    权：深圳市华移科技股份有限公司
　       制 作 者：华移科技开发二部事业部技术支持组
            联系方式：15068806232
...
zhuoyue_api
  ...
  ├src┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈类文件夹
  │  │
  │  ├com.cnmobi.teacherclient.api
  │  │  │
  │  │  └TeacherAPIController.java┈┈┈┈┈讲师所有信息接口文件
  │  │
  │  │
  │  │
  │  │
  │  └com.cnmobi.zhuoyue.api.v1
  │     │
  │     ├CommonAPIController.java┈┈┈┈┈┈公共模块的 api
  │     │
  │     ├CourseAPIController.java┈┈┈┈┈课程相关
  │     │
  │     ├FileAPIController.java┈┈┈┈┈文件上传总的控制器 学生头像上传
  │     │
